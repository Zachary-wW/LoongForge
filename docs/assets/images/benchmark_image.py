...
def main():
    ...
    for i, (model, mtype, speedup) in enumerate(ROWS):
        ...
        # Track
        _rounded(ax, track_x0, y0, TRACK_X1, y1, fc=COLOR_TRACK, ec="none", zorder=2)
