...
def _add_extra_bridge_args(parser):
    ...
    # args are snake_case).
    group.add_argument(
        "--fp8-force-no-requant",
        "--fp8_force_no_requant",
        dest="fp8_force_no_requant",
        action="store_true",
        help=(
    ...
    group.add_argument(
        ...
        action="store_true",
        help=(
            "If enabled, on-the-fly dequantize compressed-tensors packed INT4 "
    ...
    group.add_argument(
        ...
        action="store_true",
        help=(
            "If enabled, on-the-fly dequantize MXFP4 packed FP4 weights "
    ...
    group.add_argument(
        ...
        default="bfloat16",
        help=("Target dtype for INT4 dequantization (bfloat16 or float32). Default: bfloat16"),
    )
    group.add_argument(
        ...
        default=None,
        help=(
            "Path to config.json carrying the compressed-tensors quantization_config; "
...
def _add_extra_video_args(parser):
    ...
    group.add_argument(
        ...
        type=tuple,
        default=(1, 1, 1),
        help="Patch size (time, height, width) for latent space tokenization. Default: (1, 1, 1)",
    )
    ...
    group.add_argument(
        ...
        type=float,
        default=1.0,
        help="Maximum diffusion timestep boundary (0-1 range) for DiT models. Default: 1.0",
    )
    ...
    group.add_argument(
        ...
        type=float,
        default=0.0,
        help="Minimum diffusion timestep boundary (0-1 range) for DiT models. Default: 0.0",
    )
    ...
    group.add_argument(
        ...
        type=str,
        default=None,
        help="Path to dataset metadata file containing video/image information. Default: None",
    )
...
def _add_extra_training_args(parser: argparse.ArgumentParser):
    ...
    group.add_argument(
        "--use-dsa-fused",
        action="store_true",
        help="Force use of Omni fused DSA implementation for DeepSeek models. Default: False",
    )
    ...
    group.add_argument(
        ...
        type=float,
        default=0.9999,
        help="Decay rate for EMA parameter updates. Higher values = slower update. Default: 0.9999",
    )
    ...
    group.add_argument(
        ...
        type=str,
        default=None,
        help="Directory path to save EMA checkpoints. Defaults to ${args.save}/ema. Default: None",
    )
    ...
    group.add_argument(
        ...
        action="store_true",
        default=False,
        help="Log GPU memory statistics (allocated/peak) during training. Default: False",
    )
