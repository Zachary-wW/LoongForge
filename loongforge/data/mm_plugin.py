...
class MiniCPMV46Plugin(MMPlugin):
    ...
    def _video_placeholder(self, token_count: int, video_index: int, *, use_image_id: bool) -> str:
        placeholder = f"{self.image_start_token}{self.video_token * token_count}{self.image_end_token}"
        if use_image_id:
            placeholder = f"{self.image_id_start_token}{video_index}{self.image_id_end_token}" + placeholder
        return placeholder
