...
#                !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
#           This file was automatically generated from src/transformers/models/qwen2_5_vl/modular_qwen2_5_vl.py.  # noqa: E501
#               Do NOT edit this file manually as any edits will be overwritten by the generation of
#             the file from the modular. If any change should be done, please apply the change to the  # noqa: E501
...
class Qwen25VLVisionFlashAttention2(nn.Module):
    ...
    def forward(
        ...
        if position_embeddings is None:
            logger.warning_once(
                "The attention layers in this model are transitioning from computing the RoPE embeddings internally "  # noqa: E501
                "through `rotary_pos_emb` (2D tensor of RoPE theta values), to using externally computed "  # noqa: E501
                "`position_embeddings` (Tuple of tensors, containing cos and sin). In v4.54 `rotary_pos_emb` will be "  # noqa: E501
...
class Qwen25VLVisionBlock(nn.Module):
    ...
    def forward(
        ...
        if self.use_selective_recompute:
            ...
            # residual RMS is not used by subsequent computation and is usually unused in large-model training  # noqa: E501
            _ = None
        else:
...
class Qwen25VLRotaryEmbedding(nn.Module):
    ...
    def __init__(self, config: Qwen25VLConfig, device=None):
        ...
        # Newer versions remove the "default" key from ROPE_INIT_FUNCTIONS and compute default RoPE inline.  # noqa: E501
        # Older versions (4.x): ROPE_INIT_FUNCTIONS["default"] exists and can be used normally.
        # Newer versions (5.x): when rope_type=="default", use compute_default_rope_parameters instead.  # noqa: E501
    ...
    def forward(self, x, position_ids):
        ...
        # Core RoPE block. In contrast to other models, Qwen2_5_VL has different position ids for thw grids  # noqa: E501
        ...
        # Advanced RoPE types (e.g. yarn) apply a post-processing scaling factor, equivalent to scaling attention  # noqa: E501
...
class Qwen25VLSdpaAttention(Qwen25VLAttention):
    ...
    def forward(
        ...
        """Run the forward pass."""
        if output_attentions:
            # TODO: Improve this warning with e.g. `model.config.attn_implementation = "manual"` once this is  # noqa: E501
            # implemented.
            logger.warning_once(
                "This attention module is using Qwen25VLSdpaAttention, but "
                "`torch.nn.functional.scaled_dot_product_attention` does not support `output_attentions=True`. Falling "  # noqa: E501
                "back to the manual attention implementation, "
                "but specifying the manual implementation will be required from Transformers version v5.0.0 onwards. "  # noqa: E501
                'This warning can be removed using the argument `attn_implementation="eager"` when loading the model.'  # noqa: E501
            )
