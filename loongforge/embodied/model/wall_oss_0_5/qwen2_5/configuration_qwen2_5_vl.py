...
class Qwen25VLConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # - Older versions: super() sets self.pad_token_id; override it with the saved value so kwargs are preserved  # noqa: E501
        ...
        # Assign pad_token_id as described above, overriding older super() values or filling newer missing attributes  # noqa: E501
        self.pad_token_id = _pad_token_id

        # move vision config initialization after super init to avoid recursively set in latest transformers version  # noqa: E501
        # TODO: make it better
