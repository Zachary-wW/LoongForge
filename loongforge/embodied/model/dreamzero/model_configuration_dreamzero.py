...
class DreamZeroConfig(PreTrainedConfig):
    ...
    # ------------------------------------------------------------------
    action_loss_embodiment_ids: list[int] = field(default_factory=lambda: [26, 17, 32])
...
def dreamzero_dit_performance_options(
    ...
    return {
        ...
        "cache_fa_lens": _dreamzero_bool(model_config.cache_fa_lens),
        "cache_fa_lens_clone": _dreamzero_bool(model_config.cache_fa_lens_clone),
