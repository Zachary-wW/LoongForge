...
def build_arg_parser():
    ...
    ap.add_argument(
        ...
        default="mink",
        help=(
            "Trajectory and base-search IK backend: mink uses differential "
    ...
    ap.add_argument(
        "--enable_base_orientation_search",
        action="store_true",
        help=(
            "Enable balanced base pitch/yaw/roll search; by default "
    ...
    ap.add_argument(
        ...
        help=(
            "Mink maximum joint displacement from the previous "
