...
from loongforge.embodied.data.datasets.fastwam.transforms.data_configuration_fastwam import (
    FastWAMDataConfig,
)
...
_CONFIGS_DIR = (
    Path(__file__).resolve().parent.parent.parent.parent / "configs" / "models" / "embodied"
)
