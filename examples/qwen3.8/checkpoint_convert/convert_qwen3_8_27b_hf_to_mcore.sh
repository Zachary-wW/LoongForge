...
LOAD=${LOAD:-/mnt/cluster/models/Qwen3.8-27B}
SAVE=${SAVE:-/workspace/qwen3.8-27B-TP2PP1}
...
MODEL_CONFIG_FILE=${LOONGFORGE_PATH}/configs/models/qwen3.8/qwen3_8_27b.yaml

FOUNDATION_CONVERT_FILE=${LOONGFORGE_PATH}/configs/models/qwen3.8/ckpt_convert/qwen3_8_dense_convert.yaml
