...
from convert_checkpoint.utils.utils import check_all_done, make_hf_sub_checkpoints
...
def test_moe_mcore_to_hf(
    tp, pp, vpp, ep, etp, pp_ranks, tp_ranks, ep_ranks, etp_ranks, mcore_dict, encoder_tp_size=None
):
    parallel_config = ParallelConfig()
    parallel_config.vpp_size = vpp
    parallel_config.vpp_scheduler = None
