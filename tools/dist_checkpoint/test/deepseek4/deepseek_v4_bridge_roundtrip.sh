...
TOKENIZER_PATH=${TOKENIZER_PATH:-"/mnt/cluster/huggingface.co/deepseek-ai/DeepSeek-V4-Flash-Base"}
SAVE_HF_PATH=${SAVE_HF_PATH:-"/mnt/cluster/loongforge-ckpt/deepseek-v4-roundtrip-output"}
